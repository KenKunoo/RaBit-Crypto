...
const SearchInput = ({handleSearch}) => {
    ...
    return (
        <>
        <form className = 'w-96 relative flex items-center ml-7' onSubmit={handleSubmit}>
    ...
    { searchText.length > 0 ? (
         ...
         <ul className ='absolute top-11 right-0 h-96 w-96 rounded overflow-x-hidden py-2 bg-gray-200 bg-opacity-60 backdrop-blur-md scrollbar-thin scrollbar-thumb-gray-100 scrollbar-track-gray-200'> 
            {
                searchData ?
