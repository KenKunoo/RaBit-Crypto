                  ...
                  return (
                    <tr key={data.id} className='text-center text-base border-b border-gray-100 hover:bg-gray-200 last:border-b-0'>
                      <td className='py-4 flex items-center uppercase'>
                        <button className='outline-0 border-0 bg-none cursor-pointer'> <svg className='w-[1.5rem] m1-1.5 fill-gray-100 hover:fill-cyan' width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
